...
// Транспорт xhttp: в апстриме его нет, взят из форка extended и адаптирован.
// Отдельным файлом, чтобы обновления апстрима не конфликтовали.
...
type V2RayXHTTPBaseOptions struct {
	...
	XPaddingBytes        Range[int]       `json:"x_padding_bytes"`
	NoGRPCHeader         bool                       `json:"no_grpc_header,omitempty"`
	NoSSEHeader          bool                       `json:"no_sse_header,omitempty"`
	ScMaxEachPostBytes   *Range[int]      `json:"sc_max_each_post_bytes"`
	ScMinPostsIntervalMs *Range[int]      `json:"sc_min_posts_interval_ms"`
	ScMaxBufferedPosts   int64                      `json:"sc_max_buffered_posts,omitempty"`
	ScStreamUpServerSecs *Range[int]      `json:"sc_stream_up_server_secs"`
	...
	UplinkChunkSize      *Range[int]      `json:"uplink_chunk_size,omitempty"`
	SessionIDTable       string                     `json:"session_id_table,omitempty"`
	SessionIDLength      Range[int]       `json:"session_id_length,omitempty"`
...
func (c *V2RayXHTTPBaseOptions) GetNormalizedXPaddingBytes() Range[int] {
...
func (c *V2RayXHTTPBaseOptions) GetNormalizedScMaxEachPostBytes() Range[int] {
...
func (c *V2RayXHTTPBaseOptions) GetNormalizedScMinPostsIntervalMs() Range[int] {
...
func (c *V2RayXHTTPBaseOptions) GetNormalizedScStreamUpServerSecs() Range[int] {
...
func (c *V2RayXHTTPBaseOptions) GetNormalizedUplinkChunkSize() Range[int] {
...
type V2RayXHTTPXmuxOptions struct {
	MaxConcurrency   Range[int] `json:"max_concurrency"`
	MaxConnections   Range[int] `json:"max_connections"`
	CMaxReuseTimes   Range[int] `json:"c_max_reuse_times"`
	HMaxRequestTimes Range[int] `json:"h_max_request_times"`
	HMaxReusableSecs Range[int] `json:"h_max_reusable_secs"`
	HKeepAlivePeriod int64                `json:"h_keep_alive_period"`
}

func (m *V2RayXHTTPXmuxOptions) GetNormalizedMaxConcurrency() Range[int] {
	return m.MaxConcurrency
}

func (m *V2RayXHTTPXmuxOptions) GetNormalizedMaxConnections() Range[int] {
	return m.MaxConnections
}

func (m *V2RayXHTTPXmuxOptions) GetNormalizedCMaxReuseTimes() Range[int] {
	return m.CMaxReuseTimes
}

func (m *V2RayXHTTPXmuxOptions) GetNormalizedHMaxRequestTimes() Range[int] {
	return m.HMaxRequestTimes
}

func (m *V2RayXHTTPXmuxOptions) GetNormalizedHMaxReusableSecs() Range[int] {
