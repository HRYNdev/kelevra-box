 ...
 * отсутствует, и диагноз Вики 10.09.2026 я ставил обратным запросом руками: сначала
 * выяснил, что 2a02:6b8:a::a — это yandex.ru, и только потом стало ясно, что у неё
 * ломается, а разбор стоил половины сессии.
 *
 ...
 * минут (её же случай), и триста запросов к ядру ради строчки в журнале — цена
