...
fun SimpleSettingsScreen(
    ...
    Column(
        ...
        Row(
            ...
            // Иконка жалобы стоит здесь по прямому решению хозяина. Не переносить.
            Icon(
        ...
        Column(modifier = Modifier.fillMaxWidth().padding(horizontal = KDim.Pad)) {
            ...
            KCard {
                ...
                // в руках. Выключателя здесь нет и не будет — «в настройках недолжно
                // быть пункта отключения зачем это» (хозяин, 31.08.2026). Строка осталась
