...
object Settings {
    ...
    // обновления должны приходить сами, а не по кнопке
    ...
    var autoModeStickyTag by dataStore.string(SettingsKey.AUTO_MODE_STICKY_TAG) { "" }
    ...
    // сама система» — разбор 10.09.2026, второе встретилось живьём.
    ...
    /** Отказы установки подряд на одну версию, «номер версии:отказов». */
    var updateInstallFailures by dataStore.string(SettingsKey.UPDATE_INSTALL_FAILURES) { "" }
